// gtk3_glx.c
//
// OpenGL-testprog with Gtk3 + gtk_drawing_area_new + GLX
//   for OpenGL versions prior 3;
// DOES NOT GET Z-BUFFER; displays only 2D.
//
// build & start:
...
//================================================================
  int realize (GtkGLArea *parent, void *event, void *data) {
//================================================================
  ...
  GLB_x_id = gdk_x11_window_get_xid (gtk_widget_get_window (glarea));
    printf(" GLB_x_id=%d\n",GLB_x_id);
