...
//================================================================
void TX_Write (char* txt, ...) { printf("%s\n",txt); }
// see also ../ut/ut_TX.c
...
// button pressed
  ...
  // first char = nr of pressed button; 0=first.
...
//================================================================
  ...
  gtk_widget_set_hexpand (scrolled_win, TRUE);             // else no resize !!
  gtk_widget_set_vexpand (scrolled_win, TRUE);             // else no resize !!
...
//   GUI_dlg1_list1_msbt = 0;
  ...
  // box0 = gtk_vbox_new (TRUE, 0);   // gtk2
  box0 = gtk_box_new (GTK_ORIENTATION_VERTICAL, 0);   // gtk3
